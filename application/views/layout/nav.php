            ...
            <nav class="navbar navbar-light p-0">
                <form class="form-inline mt-2" autocomplete="off">
                    ...
                    <div class="autocompletar">
                        <input name="search" id="search" url="<?= $this->uri->segment(1);?>" class="form-control mr-2" type="search" autocomplete="off" aria-label="Search" style="display: <?= $this->uri->segment(2) == 'agregar_incidencia' ? 'none' : 'inline-block'; ?>;">                        
